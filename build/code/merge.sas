	...
	%do y=1999 %to 2013 %by 2;
		...
		data temp&y.(drop=rel&y. seqno&y.);
			merge 	out.person(keep=pid id&y. rel&y. seqno&y. where=(rel&y.=10 & seqno&y.=1))
					out.housing(keep=id&y. hmval&y. mortgage&y. secMtg&y. hmowner&y.)
					...
					out.head(keep=id&y. headmarital&y.  headedu&y.  headrace&y.  headstatus&y.  selfemploy&y.  famsize&y.  headocc&y.  headind&y.);
			by id&y.;
		run;
